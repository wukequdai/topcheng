<%
'单页
Const SubBanner=1       	  '栏目 banner       1为显示，0为不显示
...
'文章列表
Const SubEliteN=1       	  '详细 推荐      1为显示，0为不显示
...
'应用列表
Const SubEliteA=0       	  '详细 推荐      1为显示，0为不显示
Const SubKwdA=1       		  '详细 关键词    1为显示，0为不显示
Const SubCanshuA=1       	  '详细 简述      1为显示，0为不显示
Const SubPicA=1       		  '详细 上传      1为显示，0为不显示
Const SubPicBatchA=1		  '详细 批量上传   1为显示，0为不显示
Const SubTitleA="图片"
